# 📘 Smart Dustbin (Automatic Lid) Using Arduino


![Alt text](https://panda-css.com/panda-bubble-tea.svg)
...
A Smart Dustbin is an automated waste bin that opens its lid automatically when a person approaches. The system uses an ultrasonic sensor to detect distance and a servo motor to open and close the lid without physical contact.
